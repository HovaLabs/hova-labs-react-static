...
export default (): React.ReactElement => (
  <div>
    ...
    <code>cube([10, 20, 30]);</code>
    <div>
      OpenSCAD is great for parametric modeling. If you want to make ten
      objects, each with a hole that is 0.2mm larger than the last, OpenSCAD is
      the way to go. Unfortunately, I discovered throughout my design process
    ...
    <div>
      ...
      violin that can extend to any CAD program. As a salute to humble
      beginnings, check out my "hello world" violin neck.
    </div>
    ...
    <div>
      More code from the OpenScad attempt at Hovalin can be found
      {" " /* eslint-disable-line */ }
      <a href="https://github.com/matthova/hovalin.git">here</a>
      {" " /* eslint-disable-line */ }
      .
    </div>
  </div>
