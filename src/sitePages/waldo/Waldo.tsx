      ...
      <div>
        ...
        <div>
          <ul>
            ...
            <li>
              Super hate company wide emails that tell where a person is going
              if they are Out of the Office, so we wanted to show everyone's OOO
              status.
            </li>
            <li>
        ...
        <div>
          We were the first (and only, to our knowledge) hack week project to
        ...
        <div>
          ...
          portfolio one you can see), I made a cute sign in page for the
          “welcome” page. I also made a little logo to go along with the title
          in the top nav.
        </div>
      </div>
      <Button
