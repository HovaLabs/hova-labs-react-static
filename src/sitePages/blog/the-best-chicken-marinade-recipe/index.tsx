...
const TheBestChickenMarinadeRecipe: React.FC<{}> = () => (
  <BlogContainer blogManifest={{ ...blogManifest, hero }}>
    ...
    <h3>Instructions:</h3>
    <div>
      Mix together everything except the chicken and put into a large ziplock
      bag or tupperware container.
    </div>
    <div>
      Stab that chicken with a fork. Really go to town on it, on both sides, so
      the tasty marinade can get into every nook and cranny.
    </div>
    <div>
      Put the chicken into the marinade container and let it marinate for a few
      hours. How long? I don't know, probably at least an hour. Try it out and
      see what works for you 😄
    </div>
    <img src={chickenInMarinade} alt="chicken in marinade" />
    <h2>Grilling:</h2>
    <div>
      Set the grill to medium heat. To keep the chicken from sticking, consider
      brushing a bit of oil onto the grilling area. Cook ~6 minutes per side.
      Per
    ...
    <img src={chickenCooked} alt="chicken cooked" />
    <h2>Enjoy!</h2>
  </BlogContainer>
);
